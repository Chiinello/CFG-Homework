...
class Student:
    ...
    def introduction(self, name, age, unique_id):
        print(f"Hi, my name is {name} , I am {age}, my student id is {unique_id}")


person_1 = Student("Chinelo", "21", "1234")

person_1.introduction("Chinelo", "21", "1234")
...
class CFGStudent(Student):
    ...
    def overall_marks(self, num):
        sum_scores = 0
        for i in num:
            sum_scores = sum_scores + i

        avg = sum_scores / len(num)
        return avg
...
# INTRODUCTION
person_3.introduction("Micheal", "30", "3441")
...
# OVERALL MARKS
print("The average score is", person_3.overall_marks([85, 47, 66, 100, 67]))